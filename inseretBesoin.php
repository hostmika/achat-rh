                        ...
                        <form action="insertAchat.php" method="POST">
                            <div class="row">
                                    ...
                                    <div class="input_field">
                                        <li>Besoins</li>
                                            <select name="produit"  required>
                                                <?php foreach($produit as $row1) { ?>
                                                <option value="<?php echo($row1[0]);?>" style="color: grey;"><?php echo($row1[1]);?> </option>
                                                <?php }?>
                                            </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="input_field">
                                        <li>quantiter</li>
                                        <input type="number" placeholder="Qte"  name="quantiter" required>
                                        <br> <br>
                                    </div>
                                </div>
                                <div class="col-md-12">
