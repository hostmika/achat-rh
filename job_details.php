<?php 
    ...
    $stmt = $conn->prepare("SELECT * FROM `annonce` WHERE poste=:poste" );
    $stmt->execute(array('poste' => $poste));
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <div class="custom-file">
                                          ...
                                          <label class="custom-file-label" for="inputGroupFile03">Votre CV</label>
                                        </div>
                                      </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="input_field">
                                        <textarea name="#" id="" cols="30" rows="10" placeholder="Lettre de motivaiton"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                    ...
                    <div class="job_sumary">
                        ...
                        <div class="job_content">
                            <ul>
                                ...
                                <li>Poste : <span><?php echo $row['poste']; ?> </span></li>
