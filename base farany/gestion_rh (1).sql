...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 06 déc. 2021 à 10:59
...
INSERT INTO `besoin_departement` (`idbesoin_departement`, `idDepartement`, `idbesoin`, `quantiter`, `idProduits`, `valider`, `commander`, `boncommade`) VALUES
(10, 1, NULL, 2, 4, 1, 1, 0),
(11, 1, NULL, 5, 1, 1, 1, 0),
(12, 1, NULL, 5, 1, 1, 1, 0),
(14, 1, NULL, 2, 4, 1, 1, 0),
