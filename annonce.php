            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="apply_job_form white-bg">
                        <h4>Lancer une annonce</h4>
                        <form action="insert_annonce.php" method="POST">
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="input_field">
                                        <input type="text" placeholder="diplome" name="diplome" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="input_field">
                                        <input type="text" placeholder="expériences" name="experience" required>
                                    </div>
                                </div>
                                
                                <div class="col-md-12">
                                    <div class="input_field">
                                        <li style="color:grey ; margin-left:5px;">date limite</li>
                                        <input type="date" name="date_lim" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input_field">
                                        <input type="number" placeholder="age min" name="age_min">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input_field">
                                        <input type="number" placeholder="age max" name="age_max">
                                    </div>
                                </div>
                                
                                <div class="col-md-12">
                                    <div class="input_field">
                                        <textarea name="description" id="" cols="50" rows="100" placeholder="Déscription..." required></textarea>
                                    </div>
                                </div>
                                <br>
                                <div class="col-md-12">
                                    <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="sexe" id="inlineRadio1" value="1">
                                          <label class="form-check-label" for="inlineRadio1">Masculin</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="sexe" id="inlineRadio2" value="2">
                                          <label class="form-check-label" for="inlineRadio2">Feminin</label>
                                        </div>
                                </div>
                                <br><br>
                                <div class="col-md-12">
                                    <li style="color:grey">Type de contrat :</li><br>

                                    <div class="input_field">
                                        <select name="contrat" id="cars" required>
                                            <option value="1" style="color: grey;">temps pleins </option>
                                            <option value="2" style="color: grey;">temps partiel </option>
                                        </select>
                                    </div>
                                </div>
                                <br><br>
                                ...
                                <div class="col-md-12">
                                    <div class="submit_btn">
                                        <button class="boxed-btn3 w-100" type="submit">valdier</button>
                                    </div>
                                </div>
                            </div>
                        </form>
