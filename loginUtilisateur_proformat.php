...
<html lang="en">
<head>
	<title>Utilisateur proformat</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="traitementProformat.php" method="post">
					<span class="login100-form-title">
						Utilisateur proformat
					</span>

					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="login" placeholder="login" value="koto">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="pass" placeholder="Password" value="koto123">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
